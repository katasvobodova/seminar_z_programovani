...
if chces_graf == "ko":
    ...
    # Bind the arrow keys to functions
    screen.listen()  # Set focus to the screen to capture key presses
    screen.onkeypress(move_up, "Up")     # Bind Up arrow key
    screen.onkeypress(move_down, "Down") # Bind Down arrow key
    screen.onkeypress(move_left, "Left") # Bind Left arrow key
    screen.onkeypress(move_right, "Right")# Bind Right arrow key
