...
def Nakres_hezký_obrázek():
    # Parametry pro kreslení různých kvadratických funkcí
    ...
    for i, color in enumerate(colors):
        ...
        # Kvadratické funkce s různými parametry
        a = 0.01 * (i + 1)  # Strmost paraboly
        b = -20 * i         # Posun paraboly
        c = 50 - 10 * i     # Posun nahoru/dolů
        
        # Kreslení
        Nakres_kvadraticke_fce(a, b, c)
    
    # Aktualizace plátna
    turtle.update()
Nakres_hezký_obrázek()
